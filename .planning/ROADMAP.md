...
| 12 | Driver Mobile App | Port core functionality của Driver ra React Native app để cài trên đt. | MOBILE-01, MOBILE-02 | 3 |
...
**Plans:** 3 plans
Plans:
- [x] 10-01-PLAN.md — Hạ tầng Socket.IO & Thông báo thời gian thực
- [x] 10-02-PLAN.md — Hệ thống Tin nhắn: Data & API
- [x] 10-03-PLAN.md — Hệ thống Tin nhắn: Realtime & Giao diện
Success criteria:
...
**Plans:** 3 plans
Plans:
- [x] 11-01-PLAN.md — Hệ thống Ví & Giao dịch (Database & Core)
- [x] 11-02-PLAN.md — Tích hợp Cổng thanh toán ZaloPay (Backend Integration)
- [x] 11-03-PLAN.md — Giao diện Thanh toán & Dashboard Admin
Success criteria:
...
**Phase 12: Mobile MVP (Driver App)**
Goal: Xây dựng App cho thiết bị di động bằng React Native (Expo) dành riêng cho Tài xế.
Requirements: MOBILE-01, MOBILE-02
**Plans:** 4 plans
Plans:
- [ ] 12-01-PLAN.md — Khởi tạo project Driver Mobile & Infrastructure
- [ ] 12-02-PLAN.md — Giao diện Đăng nhập & Logic Auth
- [ ] 12-03-PLAN.md — Lịch trình chuyến đi (Ride Schedule)
- [ ] 12-04-PLAN.md — Thông báo thời gian thực (Realtime Notifications)
Success criteria:
1. Đăng nhập thành công trên điện thoại thật/giả lập.
2. Hiển thị lịch trình chuyến đi của tài xế.
3. Nhận được thông báo thời gian thực khi có booking mới.
