...
export default function DriverTabLayout() {
  ...
  return (
    ...
    <Tabs tabBar={(props) => <RoleBottomTabBar {...props} mode={mode} />} screenOptions={{
      ...
      <Tabs.Screen name="index" options={{ title: 'Trang chủ', tabBarAccessibilityLabel: 'Trang chủ', tabBarLabel: ({ color, focused }) => <RoleTabLabel color={color} focused={focused} label="Trang chủ" />, tabBarIcon: ({ color, focused }) => <RoleTabIcon focused={focused} mode={mode}><Home size={21} color={color} strokeWidth={focused ? 2.5 : 2} /></RoleTabIcon> }} />
