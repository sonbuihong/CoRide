...
export const metadata: Metadata = {
  title: "Đăng ký tài khoản | CoRide",
  description: "Tạo tài khoản CoRide mới",
};

export default function RegisterPage() {
  return (
    <div className="flex min-h-screen flex-col items-center justify-center p-4 bg-[#f5f5f7] dark:bg-black">
      <div className="w-full max-w-[420px] space-y-10 py-12">
        <div className="flex flex-col items-center text-center">
          <h1 className="text-[40px] md:text-[48px] font-semibold tracking-[-0.28px] leading-[1.07] text-[#1d1d1f] dark:text-white mb-3">
            Đăng ký tài khoản
          </h1>
